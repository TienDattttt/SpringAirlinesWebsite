...
<body>
	<div layout:fragment="content">
		<div class="container">
			<h2 class="fw-bold mb-4 text-center">Sửa đổi hành lý</h2>
		</div>
			...
			<div class="row">
				...
				<nav class="sidebar-navigation">
					<ul style="list-style: none;">
						<li class="active"><a href="/userModifyLuggage"> <i class="fa-solid fa-suitcase-rolling"></i>
								<span class="tooltip">Hành lý</span>
							</a></li>
						<li><a href="/userModifySeats"> <i class="fa-solid fa-chair"></i> <span class="tooltip">Chỗ
									ngồi</span>
							</a></li>
					</ul>
				</nav>
				...
				<!-- luggage selection -->
				<div class="col">
					<form th:action="@{/userModifyLuggage/ProcessModifyLuggage}" th:object="${passengerListDTO}"
						method="post">
						<div class="row">
								...
								<div class="card card-pass" style="max-width: 450px;">
										...
										<div class="col">
											<div class="card-body">
												<div class="form-floating mb-3">
													...
													<label th:for="${'passenger' + passenger.passportID}">Tên
														khách</label>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col mb-3">
											...
											<select th:name="'passenger_' + ${passenger.passportID} + '_luggageIds'"
												...
												<option th:each="luggage : ${LuggageList}" th:value="${luggage.id}"
													...
													th:selected="${passenger.flightAndLuggage.get(passenger.flightAndSeats.keySet()[0]).contains(#strings.toString(luggage.id))}">
												</option>
											</select>
											<script>
