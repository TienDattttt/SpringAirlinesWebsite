...
<body>
	<div class="d-flex justify-content-center text-white" style="background-color: #ced4da">
		<h5 th:text="${'Vé đã đặt #' + bookingID}"></h5>
	</div>
	<br />
	<br />
			...
			<ul class="list-inline items">
				...
				<li th:each="flight : ${route.flights}" th:if="${flightStat.index == 0}"
					...
					<div class="px-3 text-muted">
						...
						<small class="text-danger fw-bold" th:if="${#strings.equals(#strings.toString(flight.statusID),
				...
				<div th:each="passenger, passengerIndex : *{passengerList}" class="col-lg-4 col-md-4 mb-3">
					<div class="card card-pass" style="max-width: 450px;">
						<div class="card-body">
							...
							<div th:each="flightId : ${passenger.flightAndSeats.keySet()}">
								...
								<div class="mb-3">
									<h5 class="text-primary strong">
										ID Chuyến bay: <span th:text="${flightId}"></span>
									</h5>
									<p>
										<strong>Chỗ ngồi:</strong> <span
							...
							<div class="row">
								<div class="col">
									<strong>Tổng giá hành lý:</strong> <span class="text-info float-end"
	...
	<section>
		<strong>Tổng giá vé:</strong> <span class="text-info" th:if="${totalPrice != null}"
