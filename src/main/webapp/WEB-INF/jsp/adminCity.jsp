	...
	<div layout:fragment="content">
		...
		<div class="d-flex justify-content-center">
			<div class="card mb-3" style="width: 70%;">
				<form method="post" enctype="multipart/form-data" th:action="@{/adminCity/ProcessCityModification}"
					th:object="${city}">
					<div class="row g-0">
						<div class="col-md-4">
							<img th:src="${city.imgUrl}" class="img-fluid rounded-start" alt="City Image">
						</div>
						<div class="col-md-8">
							<div class="card-body">
								<h5 class="card-title" th:text="*{name + ', ' + country.name}"></h5>
								<div>
									<textarea name="description" th:field="*{description}" th:value="${description}"
										class="form-control" placeholder="Description" style="height: 300px"
									...
									<div class="col col-10">
										<div class="upload-btn-wrapper">
											<label class="btn btn btn-info rounded-0 text-white"> <i
													...
													style="display: none;" />
											</label> <span id="fileName">Không có tập tin nào được chọn</span> <label
										...
										<div class="text-danger">
											<p th:if="${#fields.hasErrors('imgUrl')}" th:errors="*{imgUrl}"
												class="error-message"></p>
											<p id="sizeErrorMessage" style="display: none;"></p>
										</div>

										<input type="hidden" name="id" th:field="*{id}" class="form-control"> <input
											type="hidden" name="name" th:field="*{name}" class="form-control">
									</div>
									<div class="col d-flex justify-content-end align-self-start">
										<button type="submit" class="btn btn-primary rounded-0">
											<i class="fa-solid fa-plus me-2"></i>Thay đổi
										</button>
									</div>
